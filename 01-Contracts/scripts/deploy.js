async function main() {
  ...
  // TODO: Find these addresses for Goelri?
  ...
  const simpleOracle = await SimpleOracle.deploy( SUSHISWAP_FACTORY,
                                                  USDCX_ADDRESS,
                                                  ETHX_ADDRESS)
  console.log("Deployed SimpleOracle at address:", streamExchange.address);
